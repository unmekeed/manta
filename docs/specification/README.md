...
- **Appendices / приложения:**
  - [`openapi/manta.yaml`](openapi/manta.yaml) — full REST API v1 contract / полный контракт REST API v1.
