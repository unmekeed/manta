# Manta — сводка для нового чата (обновлено 2026-07-26, после спринта 66)
...
коммитах по спринтам (1–66). Спецификация — `docs/specification/`,
...
- ~~D6~~ ✅ спринт 57: docs/security-review.md + `make security-scan`
  ...
  Открытое: stdlib Go 1.24.7 (26/22 достижимых — нужен тулчейн
  1.25.12+), JWT/RBAC, TLS, GDPR-эндпоинты (erasure/export,
  псевдонимизация никнеймов) — всё это гейты B4, не блокеры стенда.
